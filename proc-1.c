...
ssize_t simple_proc_read(struct file *sp_file, char __user *buf, size_t size,
                         loff_t *offset) {
...
ssize_t simple_proc_write(struct file *sp_file, const char __user *buf,
...
struct file_operations fops = {.open = simple_proc_open,
